...
<%@ page import="com.rural5g.model.Doador_pj"%>
<%@ page import="com.rural5g.dao.Doador_pjDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Doador_pj | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Doador PJ</button>
		</div>
		<h1 class="text-center">DOADORES PJ:</h1>
		<table class="table table-bordered table-hover table-danger p-5">
			...
			<tbody>
				<%
				for (Doador_pj doador : Doador_pjDAO.getDoadores_pj()) {
				%>
				<tr>
					<td><%=doador.getId_doador()%></td>
					<td><%=doador.getNome()%></td>
					<td><%=doador.getEmail()%></td>
					<td><%=doador.getCelular()%></td>
					<td><%=doador.getCnpj()%></td>
					...
					<form class="" action="update" method="post">
						<div class="form-floating mb-3">
							<input type="text" name="id_doador_pj"
								...
								for="floatingInput">Digite o ID do doador PJ</label>
						</div>
						<div class="form-floating mb-3">
						...
						<div class="form-floating mb-3">
							<input type="text" name="email"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite o email</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" name="celular"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite o celular</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" name="cnpj"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite o CNPJ</label>
						</div>
						<button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger"
