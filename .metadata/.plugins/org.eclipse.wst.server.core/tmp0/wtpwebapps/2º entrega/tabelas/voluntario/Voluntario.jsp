...
<%@ page import="com.rural5g.model.Voluntario"%>
<%@ page import="com.rural5g.dao.VoluntarioDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Voluntario | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Voluntario</button>
		</div>
		...
		<table class="table table-bordered table-hover table-danger p-5">
			...
			<tbody>
				<%
				for (Voluntario voluntario : VoluntarioDAO.getVoluntarios()) {
				%>
				<tr>
					<td><%=voluntario.getId_voluntario()%></td>
					<td><%=voluntario.getNome()%></td>
					<td><%=voluntario.getCpf()%></td>
					<td><%=voluntario.getCelular()%></td>
					<td><%=voluntario.getEmail()%></td>
					<td><%=voluntario.getEstado()%></td>
					<td><%=voluntario.getCidade()%></td>
					<td><%=voluntario.getBairro()%></td>
					<td><%=voluntario.getFormacao()%></td>
					...
					<form class="" action="update" method="post">
						<div class="form-floating mb-3">
							<input type="text" name="id_voluntario"
								...
								for="floatingInput">Digite o ID do voluntario</label>
						</div>
						<div class="form-floating mb-3">
