...
<%@ page import="com.rural5g.model.Escola"%>
<%@ page import="com.rural5g.dao.EscolaDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Escola | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Escola</button>
		</div>
		...
		<table class="table table-bordered table-hover table-danger p-5">
			...
			<tbody>
				<%
				for (Escola escola : EscolaDAO.getEscolas()) {
				%>
				<tr>
					<td><%=escola.getId_escola()%></td>
					<td><%=escola.getNome()%></td>
					<td><%=escola.getNome_coordenador()%></td>
					<td><%=escola.getEstado()%></td>
					<td><%=escola.getCidade()%></td>
					...
					<form class="" method="post" action="delete">
						<div class="form-floating mb-3">
							<input type="text" name="id_escola"
								...
								o id da escola que deseja excluir</label>
						</div>
			...
			<div class="modal-content rounded-4 shadow">
				...
				<div class="modal-body p-5 pt-0">
					<form class="" action="update" method="post">
						...
						<div class="form-floating mb-3">
							<input type="text" name="nome_coordenador"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite o nome do(a) coordenador(a)</label>
						</div>
