...
<%@ page import="com.rural5g.model.Patrocinador"%>
<%@ page import="com.rural5g.dao.PatrocinadorDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Patrocinador | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Patrocinador</button>
		</div>
		...
		<table class="table table-bordered table-hover table-danger p-5">
			...
			<tbody>
				...
				%>
				<tr>
					<td><%=patrocinador.getId_patrocinador()%></td>
					<td><%=patrocinador.getNome()%></td>
					<td><%=patrocinador.getCpf()%></td>
					<td><%=patrocinador.getCelular()%></td>
					<td><%=patrocinador.getEmail()%></td>
					<td><%=patrocinador.getEstado()%></td>
					<td><%=patrocinador.getCidade()%></td>
					<td><%=patrocinador.getBairro()%></td>
				...
				<div class="modal-body p-5 pt-0">
					<form class="" method="post" action="delete">
						<div class="form-floating mb-3">
							<input type="text" name="id_patrocinador" class="form-control rounded-3"
								id="floatingInputL" placeholder="ID"> <label
								for="floatingInput">Digite o id do patrocinador que deseja
								excluir</label>
						</div>
