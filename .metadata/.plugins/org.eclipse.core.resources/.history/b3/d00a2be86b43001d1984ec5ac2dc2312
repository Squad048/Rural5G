...
<%@ page import="com.rural5g.model.Doador_pf"%>
<%@ page import="com.rural5g.dao.Doador_pfDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Doador_pf | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Doador PF</button>
		</div>
		<h1 class="text-center">DOADORES PF:</h1>
		<table class="table table-bordered table-hover table-danger p-5">
			...
			<tbody>
				<%
				for (Doador_pf doador : Doador_pfDAO.getDoadores_pf()) {
				%>
				<tr>
					...
					<form class="" action="update" method="post">
						<div class="form-floating mb-3">
							<input type="text" name="id_doador_pf"
								...
								for="floatingInput">Digite o ID do doador PF</label>
						</div>
						<div class="form-floating mb-3">
						...
						<div class="form-floating mb-3">
							<input type="text" name="cpf"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite o CPF</label>
						</div>
						<button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger"
