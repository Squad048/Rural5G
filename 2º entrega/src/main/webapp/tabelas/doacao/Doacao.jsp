...
<%@ page import="com.rural5g.model.Doacao"%>
<%@ page import="com.rural5g.dao.DoacaoDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Doacao | Rural 5G</title>
	...
	<section class="container p-5">
		<div class="d-flex flex-row-reverse">
			<button class="btn btn-danger" data-toggle="modal"
				data-target="#modalCreate">Cadastrar Doação</button>
		</div>
		...
		<table class="table table-bordered table-hover table-danger p-5">
			<thead>
				<tr>
					...
					<th>Id Escola</th>
					<th>Id Doador</th>
					<th>Entidade Doador</th>
					<th>Opções</th>
				</tr>
			</thead>
			<tbody>
				<%
				for (Doacao doacao : DoacaoDAO.getDoacoes()) {
				%>
				<tr>
					<td><%=doacao.getId_doacao()%></td>
					<td><%=doacao.getNome()%></td>
					<td><%=doacao.getId_escola()%></td>
					<td><%=doacao.getId_doador()%></td>
					<td><%=doacao.getEntidade_doador()%></td>
					...
					<form class="" action="update" method="post">
						<div class="form-floating mb-3">
							<input type="text" name="id_doacao"
								...
								for="floatingInput">Digite o ID da doação</label>
						</div>
						<div class="form-floating mb-3">
						...
						<div class="form-floating mb-3">
							<input type="text" name="entidade_doador"
								class="form-control rounded-3" id="floatingInputL"> <label
								for="floatingInput">Digite a entidade do doador(pj/pf)</label>
						</div>
						<button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger"
